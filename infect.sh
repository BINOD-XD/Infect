...
echo -e "$red                        ➡$cyan [\e[92m5\e[96m] FACEBOOK"
echo -e "$red                        ➡$cyan [\e[92m6\e[96m] GITHUB"
echo -e "$red                        ➡$cyan [\e[92m7\e[96m] WHAT'S App "
...
then
am start -a android.intent.action.VIEW -d https://facebook.com/reyadbross > /dev/null 2>&1
banner
menu
elif [ $optnz = "6" ];
then
am start -a android.intent.action.VIEW -d https://github.com/BINOD-XD > /dev/null 2>&1
banner
menu
elif [ $optnz = "7" ];
then
am start -a android.intent.action.VIEW -d https://wa.me/+8801989861704 > /dev/null 2>&1
banner
menu
elif [ $optnz = "8" ];
then
